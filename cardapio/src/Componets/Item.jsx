...
const Item = ({id, nome, fonte, categoria, price, show}) => {
  ...
  return (
    <div className='bg-neutral-200 rounded-2xl p-2 md:px-3 flex-[0_0_100%] min-w-full text-center md:flex-[0_0_calc(100%/2)] lg:flex-[0_0_calc(100%/3)] mx-auto'>
      { !show  ? <div className='relative flex justify-center items-center w-full h-48 mb-4'>
